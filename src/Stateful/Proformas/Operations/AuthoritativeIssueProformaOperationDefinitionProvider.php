...
final class AuthoritativeIssueProformaOperationDefinitionProvider implements AuthoritativeOperationDefinitionProvider
{
    public static function provider(): ProviderKey
    {
        return IssueProformaOperationDefinitionProvider::provider();
    }
    ...
    public static function definitions(): iterable
    {
        ...
        yield new AuthoritativeOperationDefinition(
            ...
            writeActivation: WriteActivationContract::immediate(IssueProformaPayloadCodec::WriteActivationSlot),
            polling: null,
            ...
            transportTargets: [new TransportTargetDefinition(
                targetId: 'invoice.proforma.issue',
            ...
            projection: new ProjectionContract(
                new ServiceReference(
                    IssueProformaOutcomeProjectionPlanner::class,
            ...
            compensations: [],
            payloadCodec: new ServiceReference(IssueProformaPayloadCodec::class, OperationPayloadCodec::class),
            ...
            reconciliationStrategy: new ServiceReference(
                AuthoritativeIssueProformaReconciliationStrategy::class,
