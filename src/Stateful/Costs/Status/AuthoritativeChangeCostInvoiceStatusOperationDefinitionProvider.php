...
final class AuthoritativeChangeCostInvoiceStatusOperationDefinitionProvider implements AuthoritativeOperationDefinitionProvider
{
    public static function provider(): ProviderKey
    {
        return ChangeCostInvoiceStatusOperationDefinitionProvider::provider();
    }
    ...
    public static function definitions(): iterable
    {
        ...
        yield new AuthoritativeOperationDefinition(
            ...
            writeActivation: WriteActivationContract::immediate(ChangeCostInvoiceStatusPayloadCodec::WriteActivationSlot),
            polling: null,
            ...
            resultEnvelope: new ResultEnvelopeDescriptor(
                $resultCodec,
                ChangeCostInvoiceStatusResultCodec::resultType(),
                ChangeCostInvoiceStatusResultCodec::schemaVersion(),
            ...
            transportTargets: [new TransportTargetDefinition(
                targetId: 'invoice.cost.status.change',
                transport: 'https_json',
                method: 'POST',
                targetTemplate: '/invoices/{id}/change_status.json',
            )],
            projection: new ProjectionContract(
                new ServiceReference(
                    ChangeCostInvoiceStatusOutcomeProjectionPlanner::class,
                    OutcomeProjectionPlanner::class,
                ),
                ChangeCostInvoiceStatusOutcomeProjectionPlanner::SchemaVersion,
                [],
            ),
            observationProjection: null,
            compensations: [],
            payloadCodec: new ServiceReference(ChangeCostInvoiceStatusPayloadCodec::class, OperationPayloadCodec::class),
            ...
            reconciliationStrategy: new ServiceReference(
                AuthoritativeChangeCostInvoiceStatusReconciliationStrategy::class,
