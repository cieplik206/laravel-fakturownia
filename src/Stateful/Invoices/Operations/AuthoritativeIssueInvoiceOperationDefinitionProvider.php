...
final class AuthoritativeIssueInvoiceOperationDefinitionProvider implements AuthoritativeOperationDefinitionProvider
{
    public static function provider(): ProviderKey
    {
        return IssueInvoiceOperationDefinitionProvider::provider();
    }
    ...
    public static function definitions(): iterable
    {
        ...
        yield new AuthoritativeOperationDefinition(
            ...
            managedMutationIdentity: new ManagedMutationIdentityContract(
                ...
                semanticSlots: [IssueInvoiceOperationDefinitionProvider::SemanticSlot],
            ),
            ...
            writeActivation: WriteActivationContract::immediate(IssueInvoicePayloadCodec::WriteActivationSlot),
            polling: null,
            ...
            projection: new ProjectionContract(
                new ServiceReference(
                    IssueInvoiceOutcomeProjectionPlanner::class,
            ...
            compensations: [],
            payloadCodec: new ServiceReference(IssueInvoicePayloadCodec::class, OperationPayloadCodec::class),
            handler: new ServiceReference(IssueInvoiceOperationHandler::class, OperationHandler::class),
