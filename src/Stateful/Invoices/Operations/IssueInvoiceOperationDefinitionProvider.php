...
final class IssueInvoiceOperationDefinitionProvider implements OperationDefinitionProvider
{
    public const string OperationType = 'fakturownia.invoice.issue';

    public const string SemanticSlot = 'vat';
    ...
    public static function definitions(): iterable
    {
        yield OperationDefinition::singleEffect(
            ...
            outcomeProjector: new ServiceReference(IssueInvoiceOutcomeProjector::class, OutcomeProjector::class),
        );
    }
}
