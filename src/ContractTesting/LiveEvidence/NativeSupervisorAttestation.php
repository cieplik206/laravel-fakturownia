...
final readonly class NativeSupervisorAttestation implements JsonSerializable
{
    ...
    public static function fromArray(#[SensitiveParameter] array $document): self
    {
        ...
        $attestation = new self(
            ...
            NativeBrokerWireValidation::string($envelope, 'authorization_bundle_sha256', 'native supervisor attestation'),
            NativeBrokerWireValidation::string($envelope, 'probe_plan_sha256', 'native supervisor attestation'),
