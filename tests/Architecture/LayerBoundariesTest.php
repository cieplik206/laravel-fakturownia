...
it('owns the exact package migrations without ConnectionKey duplication or boot side effects', function (): void {
    ...
    expect($connectionKeyDeclarations)->toBe([])
        ->and($migrations)->toBe([
            ...
            packageRoot().'/database/migrations/2026_08_28_000007_create_fakturownia_attachment_workflows_table.php',
        ])
        ...
        ->and(hash_file('sha256', packageRoot().'/database/migrations/2026_08_28_000007_create_fakturownia_attachment_workflows_table.php'))
        ->toBe('53bb9146d5c0c0b2cd8946c75d8e5f66b37ff662aa03eea04a63a966a5f0a2fe')
...
it('keeps the complete public and Saloon dispatch surface closed behind the RT-3 gates', function (): void {
    ...
    expect(RequiresCapability::class)->toBeClass()
        ...
        ->and($classificationCounts)->toBe([
            ...
            'capability_contract:invoice.attachment.binary.upload' => 32,
            'capability_contract:invoice.attachment.finalize' => 69,
        ...
        ->toBe('daafbc955d8c8e46d2d043a100b588d953dcbd06c8cafddeb23921ebe96e5a7d');
...
function publicMethodInventoryErrors(array $inventory): array
{
    $allowedClassifications = [
        ...
        'capability_contract:invoice.attachment.binary.upload',
        'capability_contract:invoice.attachment.finalize',
...
function localOnlyPublicMethods(): array
{
    return [
        ...
        'Cieplik206\\Fakturownia\\Laravel\\Console\\DoctorFakturowniaCommand::__construct',
        'Cieplik206\\Fakturownia\\Laravel\\Console\\DoctorFakturowniaCommand::handle',
        ...
        'Cieplik206\\Fakturownia\\Laravel\\Console\\MaintainFakturowniaArtifactsCommand::__construct',
        'Cieplik206\\Fakturownia\\Laravel\\Console\\MaintainFakturowniaArtifactsCommand::handle',
